			...
			<td>
				<form class="form-horizontal" style="margin-top: 10px;" action="Topic_save.action" method="post" onsubmit="return checkForm()">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="title" name="topic.title" value="${topic.title }" style="width: 300px;">
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls" style="width: 800px;">
							<textarea name="topic.content" id="Content" class="ckeditor" cols="50" style="height:200px;width: 500px;" ></textarea>
						</div>
					</div>
